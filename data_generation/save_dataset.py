...
parser.add_argument("-f", "--hf", action="store_true", help="Whether or not to read the files from _hf or regular directory")
parser.add_argument("-d", "--disk", action="store_true", help="Whether or not to store files on disk rather than huggingface")
